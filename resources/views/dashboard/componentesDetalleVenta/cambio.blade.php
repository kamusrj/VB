            ...
            <table class="table table-bordered caption-top ">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col-4">
                            <input type="text" id="resultado_centavo_uno" class="form-control" readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-4">
                            <input type="text" id="resultado_centavo_cinco" class="form-control" readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-4">
                            <input type="text" id="resultado_centavo_diez" class=" form-control" readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-4">
                            <input type="text" id="resultado_centavo_veinticinco" class="form-control" readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-4">
                            <input type="text" id="resultado_dolar_uno" class="form-control" readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-4">
                            <input type="text" id="resultado_dolar_cinco" class="form-control" readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-4">
                            <input type="text" id="resultado_dolar_diez" class="form-control" readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-4">
                            <input type="text" id="resultado_dolar_veinte" class="form-control" readonly>
                        </td>
                    </tr>
                    <tr>
