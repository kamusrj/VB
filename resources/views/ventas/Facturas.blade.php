                ...
                <form method="post" action="{{ url('factura/crear') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="0" min="0" step="1" name="factura_i"
                            class="form-control" id="factura_i" oninput="actualizarTotalFacturas()">
                    </div>
                    <div class="form-group">
                        <label for="factura_f">Factura final</label>
                        <input type="number" value="0" min="0" step="1" name="factura_f"
                            class="form-control" id="factura_f" oninput="actualizarTotalFacturas()">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="0" min="0" step="1" name="cupon_i"
                            class="form-control" id="cupon_i" oninput="calcularTotalCupones()">
                    </div>
                    <div class="form-group">
                        <label for="cupon_f">Cup&oacute;n final</label>
                        <input type="number" value="0" min="0" step="1" name="cupon_f"
                            class="form-control" id="cupon_f" oninput="calcularTotalCupones()">
                    </div>
                    <div class="mb-3">
