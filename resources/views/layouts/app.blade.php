...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.0/dist/css/bootstrap.min.css" integrity="sha384-gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiG5z8P4U66W5tr6S" crossorigin="anonymous">

    <!-- Incluir Bootstrap JS desde CDN -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.0/dist/js/bootstrap.min.js" integrity="sha384-ygbV9kiqU2iSgnibCB1fOBdKB1NLpLb6bOBKb8gSmjsl5B6v56b8jFhF4Xj5SbJ6" crossorigin="anonymous">
    </script>
    <style>
        body {
...
<body>
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <button id="cerrarMenu" class="btn btn-primary d-lg-none">Cerrar Menú</button>
                </div>
            </div>
        </nav>
        <!-- Sidebar -->

        <button id="toggleMenu" class="navbar-toggler" type="button">
            <i class="fas fa-bars"></i>
        </button>

        <!-- ... -->

        <a class="navbar-brand" href="#" data-toggle="collapse" data-target="#sidebarMenu">
    ...
    <!--Main layout-->
    <main style="margin-top: 58px; margin-left:15px">
    ...
    <footer>
        Derechos de autor &copy; {{ date('Y') }} Kamus
    </footer>
    ...
    <script>
        ...
        toggleButton.addEventListener('click', function() {
            if (isMenuOpen) {
                menu.classList.remove('show-menu'); // Remover la clase para ocultar el menú
            } else {
                menu.classList.add('show-menu'); // Agregar la clase para mostrar el menú
            }
